...
data = [
    ("1. Windows OS", [
        ("Windows OS 관련 언어 공부하기", [
            ("C/C++ 기초 문법 학습", "2주"),
            ("Win32 API 기본 개념 학습", "2주"),
            ("Windows 시스템 프로그래밍 실습", "3주"),
        ]),
        ("Windows OS 관련 서적 찾고 공부하기", [
            ("'Windows Internals' 서적 정독", "4주"),
            ("'Windows System Programming' 서적 학습", "3주"),
            ("학습 내용 정리 및 노트 작성", "1주"),
        ]),
        ("Windows OS 오픈소스 분석하기", [
            ("ReactOS 소스코드 구조 분석", "3주"),
            ("Windows 관련 오픈소스 도구 분석 (Sysinternals 등)", "2주"),
            ("분석 결과 문서화", "1주"),
        ]),
    ...
    ("2. Linux OS", [
        ("Linux OS 관련 언어 공부하기", [
            ("C 언어 및 POSIX API 학습", "2주"),
            ("Shell Script 작성법 학습", "1주"),
            ("Linux 시스템 프로그래밍 실습", "3주"),
        ]),
        ("Linux OS 관련 서적 찾고 공부하기", [
            ("'Linux Kernel Development' 서적 정독", "4주"),
            ("'The Linux Programming Interface' 서적 학습", "3주"),
            ("학습 내용 정리 및 노트 작성", "1주"),
        ]),
        ("Linux OS 오픈소스 분석하기", [
            ("Linux Kernel 소스코드 구조 분석", "4주"),
            ("주요 오픈소스 프로젝트 분석 (systemd, busybox 등)", "3주"),
            ("분석 결과 문서화", "1주"),
        ]),
